...
from .remoteproxy import (ClosedError, LocalObjectProxy, NoResultError,
                          ObjectProxy, RemoteEventHandler)
...
class QtProcess(Process):
    ...
    def startEventTimer(self):
        from ..Qt import \
            QtCore  # # avoid module-level import to keep bootstrap snappy.
        self.timer = QtCore.QTimer()
